...
class MinioInteractions:
    ...
    def download_images_from_minio(self, images_name: list[str]) -> bool:
        ...
        try:
            for image_name in images_name:
                self.download_image_from_minio(image_name)
    ...
    def download_patches_from_minio(self, patch_names: list[str]) -> None:
        ...
        try:
            for patch_name in patch_names:
                self.download_patch_from_minio(patch_name)
