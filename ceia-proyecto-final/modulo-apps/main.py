...
def main():
    ...
    try:
        ...
        import apps_etiquetado.procesador_anotaciones_mongodb
        import apps_etiquetado.procesador_anotaciones_coco_dataset
        import apps_etiquetado.procesador_recortes
        import apps_etiquetado.visualizador_coco_dataset
        import apps_etiquetado.procesador_geojson_kml
