...
\begin{abstract}
  ...
  Esta memoria describe la implementación de una plataforma, desarrollada para la Intendencia de Montevideo, que utiliza visión por computadora para detectar la plaga del picudo rojo en su etapa tardía en las palmeras de esta ciudad.
