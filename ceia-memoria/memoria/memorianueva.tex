...
\usepackage{float}          % Mejora el manejo de figuras y tablas
\usepackage{makecell}
...
\setcellgapes{4pt}   % define la cantidad de espacio (ajusta a tu gusto)
\makegapedcells       % activa el espaciado en celdas

% Redefinición de caracteres problemáticos en marcadores
\hypersetup{
    pdftitle={Sistema de monitoreo del \textit{Rhynchophorus ferrugineus} en palmeras de Montevideo},
    pdfauthor={Esp. Ing. Bruno Masoller},
...
\newcommand{\degreename}{Esp. Ing.} % Cambia según tu título
\newcommand{\univname}{Universidad de la República Uruguay} % Cambia según tu universidad
...
% ===============================
% Opciones de biblatex
% ===============================
\ExecuteBibliographyOptions{
  maxnames=99,
  % url=true % Descomenta si quieres que las URLs aparezcan en las citas
}

\begin{document}

% Configuración de la portada
\posgrado{Especialización en Inteligencia Artificial} % Cambia según tu programa
...
\begin{abstract}
  ...
  Esta memoria describe la implementación de una plataforma, desarrollada para la Intendencia de Montevideo, que utiliza visión por computadora para detectar la plaga del \textit{Rhynchophorus ferrugineus} en su etapa tardía en las palmeras de esta ciudad.
