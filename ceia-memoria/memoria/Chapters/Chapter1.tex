...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.39]{./Figures/ortomosaico.png}
  \caption[Ortomosaico]{Ortomosaico tomado del parque José E. Rodó \protect\footnotemark.}
...
\begin{table}[H]
  \centering
  \caption[Comparativa de estudios]{Comparación entre diferentes estudios de detección de palmeras \citep{zhorif_implementation_2024}.}
  ...
  \begin{tabularx}{\textwidth}{ >{\raggedright\arraybackslash}X >{\raggedright\arraybackslash}p{2cm} >{\raggedright\arraybackslash}X }
    ...
    Deta Sandya Prasitha et al, 2022 \citep{prasvita_automatic_2021} & YOLOv5s, YOLOv5m, YOLOv5l, YOLOv5x & 0,82 (v5s), 0,84 (v5m), 0,85 (v5l), 0,86 (v5x). (\textit{Average F1-Score}) \\
    Nuwar et al, 2022 \citep{nuwara_modern_2022}                       & YOLOv5                             & 0,895 (\textit{F1-Score})                                                   \\
    Junos et al, 2022 \citep{junos_automatic_2022}                     & YOLOv3n                            & 97,20\% (mAP), 0,91 (\textit{F1-Score})                                     \\
    \bottomrule
    \hline
  \end{tabularx}
