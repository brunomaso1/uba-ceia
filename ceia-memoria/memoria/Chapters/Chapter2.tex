...
\begin{itemize}
	\item AP: para cada clase de objeto, se calcula como el área bajo la curva de precisión–recuperación (\textit{Precision–Recall}), obtenida al variar el umbral de decisión del detector \citep{wikipedia_curva_2025}. La AP resume el rendimiento del modelo considerando el compromiso entre precisión y recuperación en distintos niveles de confianza.
