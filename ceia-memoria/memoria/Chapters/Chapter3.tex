...
La estructura de entrenamiento se basó en la plantilla de \textit{cookiecutter data science}, que permite organizar los datos y scripts de manera eficiente y reproducible. En esta plantilla se define una estructura de directorios común a proyectos de ciencia de datos, la cual fue adaptada a este proyecto de la siguiente:
