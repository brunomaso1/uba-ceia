...
El valor final al usuario es un mapa con las palmeras detectadas y clasificadas por su estado de salud. Esta información se puede descargar en un KML \citep{noauthor_kml_2024} para importar en otras herramientas utilizadas por varios equipos que gestionan la expansión de la plaga. También se puede descargar la imagen para verificar la visualización de las detecciones.
